...
const email = localStorage.getItem(LOCAL_STORAGE.EMAIL); 

export const ReserveForm = props => (

  <Formik initialValues={{ email: email, workspaceId: '', startDate: '', endDate: '' }} {...props}>
...
// for (let i = 1; i < 68; i++){
//   //generate option for each workspace id
//   var select = document.getElementById('workspaceId');
//   var option = document.createElement('option');
//   option.value = i; 
//   option.innerHTML = "Workspace #" + i;
